...
class PallyConDrmTokenClient:
    ...
    def policy(self, policy_request):
        ...
        policy = policy_request.toJsonString()
    ...
    def __validation(self):
        ...
        if isinstance(security.playready_security_level, bool) or not isinstance(security.playready_security_level, int):
        ...
        if isinstance(security.output_protect.control_hdcp, bool) or not isinstance(security.output_protect.control_hdcp, int):
